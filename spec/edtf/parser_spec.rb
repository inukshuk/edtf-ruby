module EDTF
  describe Parser do
    describe '#parse' do
      ...
      it 'parses negative unspecified centuries' do
        expect(Parser.new.parse('-19uu-uu-uu')).to be_unspecified
        expect(Parser.new.parse('-19uu-uu-uu').to_s).to eq('-19uu-01-01')
      end
